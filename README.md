...
My Companion Hub is a sophisticated Next.js application that enables users to create, manage, and interact with AI-powered companions. It features persistent contextual chat, dynamic state tracking (outfit, location, actions), and seamless image generation using Stable Diffusion, all orchestrated via Temporal workflows.
Key Features
     ...
     Dynamic Image Generation:
        ...
        Smart Layering: Logic to handle clothing layering (e.g., hiding underwear under jeans) to ensure high-quality generations.
